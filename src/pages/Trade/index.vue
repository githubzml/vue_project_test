...
export default {
  ...
  methods: {
    getUserAdressList() {
      this.$store.dispatch("atrade/getUserAddressList");
    },
    getTradeInfo() {
      this.$store.dispatch("atrade/getTradeInfo");
    },
    //排他
    ...
    async submitOrder() {
      ...
      let tradeInfo = {
        consignee: this.defaultAdress.consignee,
        consigneeTel: this.defaultAdress.phoneNum,
        deliveryAddress: this.defaultAdress.fullAddress,
        paymentWay: "ONLINE",
  ...
  computed: {
    ...mapState("atrade", ["userAddressList"]),
    ...mapState("atrade", ["tradeInfo"]),
    defaultAdress() {
